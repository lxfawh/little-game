...
App({
  ...
  globalData: {
    ...
    lib1: ['这是啥 啊...记不起来啦...', 'props少许', '搞不清楚放了什么 总之放了很多...', '呃啊啊啊啊', '加一点点props', '去打了个盹儿...', '完了，props打翻了...', 'common'],

    lib2: ['这是啥 啊...记不起来啦...', '去打了个盹儿...', '搞不清楚放了什么 总之放了很多...', '哎呦，超能力好像用完了,那就拿props代替吧', '呃啊啊啊啊', '加一点点props', '要不加点props恶搞一下', '再补一点props', '要不再加点props', '完了，props打翻了', 'common'],

    lib3: ['这是啥 啊...记不起来啦...', '就是看不惯你这么props才假装失手的', '然后倒掉，让你空欢喜一场', '应该差不多了...', '搞不清楚放了什么 总之放了很多...', '哎呦，超能力好像用完了,那就拿props代替吧', '呃啊啊啊啊', '加一点点props', '还要加啥来着？算了 就这样吧...', '要不加点props恶搞一下', '想加异性缘，加错了..放成props了', '还是不够，props都加给你吧！', '后悔了，倒掉', '加全部的props进去', '完了，props打翻了', '哎呦，刚手滑倒入了全部props', 'common'],
