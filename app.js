...
App({
  ...
  globalData: {
    ...
    //参考···
    result: ['这是啥 啊...记不起来啦...', '去打了个盹儿...', '那就加点props吧', '想加props，加错了..放成props了', '在补一点props', '加一整桶props进去', '完了，props打翻了', '就是看不惯你这么props才假装失手的', '加一点点props', '要不再加点props', '还是不够，props都加给你吧！', '后悔了，倒掉', '骗你的，props都加给你', '哎呦，props好像用完了,那就拿props代替吧', '呃啊啊啊啊', '搞不清楚放了什么，总之放了很多', 'props打翻了', 'props也打翻了', '...对不住了 你自己奋斗吧', '那就加点props吧', '然后倒掉，让你空欢喜一场', '应该差不多了', '嫌麻烦，所以什么都没放 辛苦你了...', '要不加点props恶搞一下', '还要加啥来着？算了，就这样吧'],
